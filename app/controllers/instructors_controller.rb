class InstructorsController < ApplicationController
  ...
  def index
    @instructors = Instructor.paginate(:page => params[:page], :per_page => 5)
  ...
  def update
    respond_to do |format|
      if @instructor.update(instructor_params)
        ...
        format.json { render :index, status: :ok, location: @instructor }
      else
  ...
  def check_name_present
    ...
    render json: @instructor.nil? ? {'msg': 'can be used'} : {'msg': 'already taken'}   
  end
